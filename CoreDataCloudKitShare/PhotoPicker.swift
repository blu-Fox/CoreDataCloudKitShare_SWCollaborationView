...
Abstract:
A view controller representable that wraps the picker view controller.
*/
...
class PhotoPickerCoordinator: PHPickerViewControllerDelegate {
    ...
    func picker(_ picker: PHPickerViewController, didFinishPicking results: [PHPickerResult]) {
        ...
        /**
          The system doesn’t automatically dismiss the picker, so nullify activeSheet to do that.
         */
        photoPicker.activeSheet = nil
    }
